...
**Step 2** : Install MAVLink: we use the Kinetic reference for all ROS
distros as it’s not distro-specific and up to date
...
Modify your .bashrc file, open it up in a text editor and add the
