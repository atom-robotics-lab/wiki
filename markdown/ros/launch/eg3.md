...
* To write a launch ﬁle to load config_my.yaml present in pkg_ros_basics package.
* Also launch the node_param_get_set.py ROS node after loading the YAML ﬁle.
